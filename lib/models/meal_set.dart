...
final mealsList = [
  MealSet(
    ...
    timeTaken: "15 MIN",
    calories: "290",
    url:"BreakFast/SweetNuttyOatmeal.jpg",
    cover: "BreakFast/Asset1.png",
  ...
  MealSet(
    ...
    timeTaken: "15 MIN",
    calories: "260",
    url: "BreakFast/Breakfast_Burrito.jpg",
    cover: "BreakFast/Asset2.png",
    mealType: Meal.breakFast,
  ),
  MealSet(
    ...
    timeTaken: "18 MIN",
    calories: "200",
    url:"BreakFast/waffles.jpg",
    cover: "BreakFast/Asset3.png",
    mealType: Meal.breakFast,
  ),
  MealSet(
    ...
    timeTaken: "6 MIN",
    calories: "220",
    url: "BreakFast/banana.jpg",
    cover: "BreakFast/Asset4.png",
    mealType: Meal.breakFast,
  ),
  MealSet(
    ...
    timeTaken: "5 MIN",
    calories: "238",
    url:"BreakFast/berrie.jpg",
    cover: "BreakFast/Asset5.png",
    mealType: Meal.breakFast,
  ),
  MealSet(
    ...
    timeTaken: "30 Min",
    calories: "500",
    url: "BreakFast/chicken.jpg",
    cover: "BreakFast/Asset6.png",
    mealType: Meal.lunch,
  ),
  MealSet(
    ...
    timeTaken: "25 Min",
    calories: "460",
    url: "BreakFast/chicken2.png",
    cover: "BreakFast/Asset7.png",
    mealType: Meal.lunch,
  ),
  MealSet(
    ...
    timeTaken: "30 Min",
    calories: "612",
    url: "BreakFast/chicken3.jpg",
    cover: "BreakFast/Asset8.png",
    mealType: Meal.lunch,
  ),
  ...
  MealSet(
    ...
    timeTaken: "25 Min",
    calories: "430",
    url: "BreakFast/salad.jpg",
    cover: "BreakFast/Asset9.png",
    mealType: Meal.lunch,
  ),
  MealSet(
    ...
    timeTaken: "45 Min",
    calories: "425",
    url: "BreakFast/burger.jpg",
    cover: "BreakFast/Asset10.png",
    mealType: Meal.lunch,
  ),
// dinner
  MealSet(
    ...
    timeTaken: "45 Min",
    calories: "650",
    url: "BreakFast/honey.png",
    cover: "BreakFast/Asset11.png",
  ...
  MealSet(
    ...
    timeTaken: "25 Min",
    calories: "430",
    url: "BreakFast/salmon.jpg",
    cover: "BreakFast/Asset12.png",
    mealType: Meal.dinner,
  ),
  MealSet(
    ...
    timeTaken: "45 Min",
    calories: "554",
    url: "BreakFast/grilled.jpg",
    cover: "BreakFast/Asset13.png",
    mealType: Meal.dinner,
  ),
  MealSet(
    ...
    timeTaken: "40 Min",
    calories: "450",
    url: "BreakFast/soup.jpg",
    cover: "BreakFast/Asset14.png",
    mealType: Meal.dinner,
  ),
  MealSet(
    ...
    timeTaken: "1 Hr",
    calories: "700",
    url: "BreakFast/vegan.jpg",
    cover: "BreakFast/Asset15.png",
    mealType: Meal.dinner,
  ),
